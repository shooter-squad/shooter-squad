...
from EnvTreasureVector2.constants import *
from EnvTreasureVector2.bullet import *
from EnvTreasureVector2.spaceship import *
from EnvTreasureVector2.game_scene import *
from EnvTreasureVector2.shooter_env import *
from EnvTreasureVector2.obstacle import *
from EnvTreasureVector2.health_pack import *
from EnvTreasureVector2.ultimate_ability import *
from EnvTreasureVector2.utils import *
...
if __name__ == '__main__':
    ...
    agent = DQNAgent(gamma=0.99, epsilon=epsilon, lr=0.0001,
                     ...
                     chkpt_dir='models/', pre_train_dir='pre_train_models/', algo='DQNAgentTreasureVectorHunter2',
                     env_name=env_name)
    ...
    output_file_name = "stats_dqn_treasure_vector_hunter2.txt"
