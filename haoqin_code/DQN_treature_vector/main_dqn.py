...
from EnvTreasureVector.constants import *
from EnvTreasureVector.bullet import *
from EnvTreasureVector.spaceship import *
from EnvTreasureVector.game_scene import *
from EnvTreasureVector.shooter_env import *
from EnvTreasureVector.obstacle import *
from EnvTreasureVector.health_pack import *
from EnvTreasureVector.ultimate_ability import *
from EnvTreasureVector.utils import *
...
if __name__ == '__main__':
    ...
    agent = DQNAgent(gamma=0.99, epsilon=epsilon, lr=0.0001,
                     ...
                     chkpt_dir='models/', pre_train_dir='pre_train_models/', algo='DQNAgentTreasureVectorHunter',
                     env_name=env_name)
    ...
    output_file_name = "stats_dqn_treasure_vector_hunter.txt"
