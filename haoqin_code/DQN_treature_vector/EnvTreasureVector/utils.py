...
class StackFrames(gym.ObservationWrapper):
    def __init__(self, env, repeat):
        ...
        # print('Before: ', self.observation_space.shape)
        self.observation_space = gym.spaces.Box(env.observation_space.low.repeat(repeat, axis=0),
                                                env.observation_space.high.repeat(repeat, axis=0), dtype=np.float32)
        # print('After: ', self.observation_space.shape)
    ...
    def reset(self):
        ...
        # print('stack1 shape: ', np.array(self.stack).shape)
        ...
        # print('stack2 shape: ', np.array(self.stack).shape)
        # print('stack3 shape: ', self.observation_space.low.shape)
        # print('stack4', np.array(self.stack).reshape(self.observation_space.low.shape).shape)
