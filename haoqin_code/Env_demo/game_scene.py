...
import sys
sys.path.insert(0, r'../')
from Env_demo.constants import *
from Env_demo.health_pack import HealthPack
from Env_demo.obstacle import Obstacle
from Env_demo.spaceship import Spaceship, SpaceshipType
from Env_demo.ultimate_ability import UltimateAbility
