...
sys.path.insert(0, r'/home/haomingh/shooter-squad/haomingh')
from Env import *
...
if __name__ == '__main__':
    ...
    result_file = open('/home/haomingh/shooter-squad/haomingh/DQN/transformer_res/transformer_1.txt','w+')
    accuracy_transformer_1 = open('/home/haomingh/shooter-squad/haomingh/DQN/transformer_res/acc_transformer_1.txt','w+')
    #print(result_file)
    #print(accuracy_transformer_1)
    #print("*"*20)
    for i in range(n_games):
        ...
        result_file.write('episode: {0}, score: {1}, average score: {2:.1f}, best score: {3:.2f}, epsilon: {4:.2f}, steps: {5}\n'.format(i, score, avg_score, best_score,agent.epsilon, n_steps))
        #print(2)
        ...
        accuracy_transformer_1.write('episode: ' + str(i) + ' score: ' + str(score) +
                ' average score: ' + str(avg_score) + ' best score: ' + str(best_score) +
                ' epsilon: ' + str(agent.epsilon) + ' steps: ' + str(n_steps) + '\n')
